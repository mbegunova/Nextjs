...
export function useResult() {
    ...
    return [{totalPoints, rightAnswers:{right, all}, accuracyAnswers, rightTogether}, { updateResult,
        resetResult}];
}

export function updateResult({totalPoints, rightAnswers: {right, all}, accuracyAnswers}) {
